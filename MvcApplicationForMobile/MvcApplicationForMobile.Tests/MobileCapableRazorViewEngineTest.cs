...
namespace MvcApplicationForMobile.Tests
{
    ...
    /// <summary>
    ///This is a test class for MobileCapableRazorViewEngineTest and is intended
    ///to contain all MobileCapableRazorViewEngineTest Unit Tests
    ///</summary>
    [TestClass()]
    public class MobileCapableRazorViewEngineTest
    {
        ...
        /// <summary>
        ///A test for MobileCapableRazorViewEngine Constructor
        ///</summary>
        ...
        public void MobileCapableRazorViewEngineConstructorTest()
        {
            MobileCapableRazorViewEngine target = new MobileCapableRazorViewEngine();
        ...
        {
            MobileCapableRazorViewEngine target = new MobileCapableRazorViewEngine(); // TODO: Initialize to an appropriate value
        ...
        {
            MobileCapableRazorViewEngine_Accessor target = new MobileCapableRazorViewEngine_Accessor(); // TODO: Initialize to an appropriate value
            ControllerContext controllerContext = null; // TODO: Initialize to an appropriate value
            string viewName = string.Empty; // TODO: Initialize to an appropriate value
            string masterName = string.Empty; // TODO: Initialize to an appropriate value
            bool useCache = false; // TODO: Initialize to an appropriate value

...
namespace MvcApplicationForMobile.Tests
{
    ...
    /// <summary>
    ///This is a test class for StampTest and is intended
    ///to contain all StampTest Unit Tests
    ///</summary>
    [TestClass()]
    public class StampTest
    {
        ...
        public void StampConstructorTest()
        {
            Stamp target = new Stamp();
        ...
        {
            Stamp target = new Stamp(); // TODO: Initialize to an appropriate value
        ...
        public void DateModifiedTest()
        {
            ...
            Nullable<DateTime> expected = new Nullable<DateTime>(); // TODO: Initialize to an appropriate value
            Nullable<DateTime> actual;
            target.DateModified = expected;
            actual = target.DateModified;
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
